...
| After full buildout (or after a TEST phase) | `/plan:debt`                                                    | Assesses entire codebase against `my-style` standards and lists issues to address in order of severity, along with time estimates |                                                                                                  | Opus (though GLM is nearly as thorough)                                                                                                              |
...
- I've been experimenting with jcodemunch MCP to optimize token use for codebase analysis. Check out that project here: https://github.com/jgravelle/jcodemunch-mcp
